...
type SeedData = {
  users: Array<{ uid: string; name: string; age: number; email: string; username: string; password: string; accessLevel: number }>;
  roles: Array<{ id: string; label: string; description: string }>;
  userRoles: Array<{ uid: string; roleId: string }>;
  pages: Array<{ id: string; label: string; sortOrder: number }>;
  rolePageAccess: Array<{ roleId: string; pageId: string }>;
  userRights: Array<{ pageId: string; readOnly: number[]; readWrite: number[]; delete: number[] }>;
};
